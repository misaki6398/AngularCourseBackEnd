...
namespace MeetingRoom.Controllers
{
    ...
    public class MeetingRoomsController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<MeetingRoomModel>> GetMeetingRoom(int id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutMeetingRoom(int id, MeetingRoomModel meetingRoom)
        {
        ...
        // more details, see https://go.microsoft.com/fwlink/?linkid=2123754.
        [HttpPost]
        public async Task<ActionResult<MeetingRoomModel>> PostMeetingRoom(MeetingRoomModel meetingRoom)
        {
        ...
        [HttpDelete("{id}")]
        public async Task<ActionResult<MeetingRoomModel>> DeleteMeetingRoom(int id)
        {
            var meetingRoom = await _context.MeetingRooms.FindAsync(id);
            if (meetingRoom == null)
            {
